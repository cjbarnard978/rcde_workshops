...
You can use OpenOD to run certain graphical applications like Jupyter
...
5 CPUs, 10 GB of memory, no GPU, 1g interconnect (that is, a c1 node), for the wall time
